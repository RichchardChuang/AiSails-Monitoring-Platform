...
const TOPOLOGY_CONFIG = {
  devices: [
    ...
    },
    {
      ...
      position: [1, 0, 0.5],
      color: '#00d4ff',
      dataPath: 'Gridcon.BatterySOC',
      onlineCheck: (data) => Object.keys(data?.skysails?.groups?.Gridcon).length > 0,
      subLabelPath: 'Gridcon.BatterySOC.BatterySOC',
      subLabelFormat: (v) => `${v || 0} Hz`,
    },
    {
      id: 'pn14',
      label: 'PN14',
